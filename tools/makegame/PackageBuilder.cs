...
internal static partial class PackageBuilder
{
    ...
    public static PackageBuildResult Build(PackageSpecification package, bool overwrite, bool validateOnly)
    {
        ...
        var defaultConfig = DefaultConfig.Load(package.DefaultConfigPath, package.WindowMode, package.AspectRatio, package.Cycles, package.CpuType, package.EnableScanlines, package.EnableCrtFilter);
